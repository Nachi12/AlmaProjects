...
const MyInterviews = () => {
  ...
  const resourceMapping = {
    frontend: [
      ...
      { title: "Frontend Interview Handbook", url: "https://www.frontendinterviewhandbook.com" },
    ],
    backend: [
      { title: "Node.js Best Practices", url: "https://github.com/goldbergyoni/nodebestpractices" },
      { title: "REST API Tutorial", url: "https://restfulapi.net" },
      { title: "Database Design Guide", url: "https://www.guru99.com/database-design.html" },
    ...
    system: [
      ...
      { title: "System Design Interview Guide", url: "https://www.educative.io/courses/grokking-the-system-design-interview" },
    ],
    behavioral: [
      ...
      { title: "Interview Preparation Tips", url: "https://www.glassdoor.com/blog/common-interview-questions" },
    ],
    hr: [
      { title: "Common HR Questions", url: "https://www.monster.com/career-advice/article/100-potential-interview-questions" },
      { title: "Salary Negotiation Tips", url: "https://www.indeed.com/career-advice/pay-salary/how-to-negotiate-salary" },
    ],
    technical: [
  ...
  useEffect(() => {
    const fetchInterviews = async () => {
      ...
      try {
        ...
        const res = await axios.get(`http://localhost:5001/api/interviews?status=${filter}`, {
          headers: {
        ...
        console.error("❌ Failed to fetch interviews:", error.response?.data || error.message);
  ...
  const filteredInterviews = interviews.filter((interview) => {
    if (filter === "upcoming") return interview.status === "scheduled" || interview.status === "upcoming";
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="bg-blue-50 dark:bg-blue-950 rounded-lg p-4">
                              ...
                              <div className="space-y-2">
                                {(resourceMapping[interview.type] || []).map((resource, idx) => (
                                  <a
                                    key={idx}
                                    href={resource.url}
                                    target="_blank"
                            ...
                            {interview.score !== undefined && interview.score !== null && (
                              <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <span className="font-bold text-lg">{interview.score}/100</span>
                                </div>
                              </div>
                            )}
